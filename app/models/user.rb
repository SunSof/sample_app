class User < ApplicationRecord
  ...
  # Посылает письмо со ссылкой на страницу активации.
  ...
  # Посылает письмо со ссылкой на форму ввода нового пароля.
  ...
  # Возвращает true, если текущий пользователь читает другого пользователя.
  ...
  # Создает и присваивает токен активации и его дайджест.
